...
def login_views(request):
    return HttpResponse("这是index应用中的login_index访问路径")


def register_views(request):
    return HttpResponse("这是index应用中的register_index访问路径")


def index_views(request):
    return HttpResponse("这是index应用中的index_views访问路径")
