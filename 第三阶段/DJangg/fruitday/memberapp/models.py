...
class GoodsType(models.Model):
    ...
    picture=models.ImageField('图片',upload_to='static/img/goo_type',default='normal.png')
...
class Goods(models.Model):
    ...
    detail=models.CharField('商品详情',max_length=2000,default='商品描述')
    picture=models.ImageField('商品照片',upload_to='static/img/goods',default='normal.png')
    isDelete=models.BooleanField(default=False)
